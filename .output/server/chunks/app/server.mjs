import { getCurrentInstance, toRef, isRef, inject, version, defineAsyncComponent, defineComponent, h, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, isReadonly, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, withCtx, createVNode } from 'vue';
...
const _routes = [
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "1",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/1",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/1-61b6de46.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-4a5151a0.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-d87d7dff.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./_nuxt/island-renderer-fa516072.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __appConfig as _, useState as a, _export_sfc as b, createError as c, useRoute as d, entry$1 as default, __nuxt_component_0$1 as e, useNuxtApp as u };
